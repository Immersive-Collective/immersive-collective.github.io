...
function undoStroke() {
    ...
    console.log("undoStroke: strokeHistory",strokeHistory)

  if (strokeHistory.length > 0) {
    const lastState = strokeHistory.pop();
    gl.bindFramebuffer(gl.READ_FRAMEBUFFER, lastState.fbo);
    ...
    gl.deleteTexture(lastState.texture);
    gl.deleteFramebuffer(lastState.fbo);
