...
const barkTexture = loadTexture(`/static/images/textures/bark/bark.png`);

const leafTextures = [
  loadTexture(`/static/images/textures/leaves/ash.png`),
  loadTexture(`/static/images/textures/leaves/aspen.png`),
  loadTexture(`/static/images/textures/leaves/oak.png`)
];
...
export class Tree extends THREE.Group {
  ...
  generate() {
    ...
    let info = `Vertex Count: ${vertexCount} | Triangle Count: ${triangleCount}`
    //console.log(info)
