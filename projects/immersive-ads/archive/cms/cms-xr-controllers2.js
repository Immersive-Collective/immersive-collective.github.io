...
function init(gltfLoader) {
    ...
    addFog(scene, 0xfffaf5, 10, 100); // Color, near distance, far distance    
...
let maxSpeed = 300.0; // Higher max speed to simulate realistic car motion
let deceleration = 0.5; // Passive deceleration for smooth stopping
let brakeForce = 3.0; // Stronger braking for quick stops
...
// // Call this after all models are loaded
// setTimeout(getWheelNodes, 3000); // Delay to ensure all GLB files are loaded
...
//     vehicleContainer.position.z += vehicleVelocity.z * deltaTime;
